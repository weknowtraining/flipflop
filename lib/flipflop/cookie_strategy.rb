...
module FlipFlop
  class CookieStrategy < AbstractStrategy
    ...
    module Loader
      ...
      included do
        before_filter :flipflop_cookie_strategy_before
        after_filter :flipflop_cookie_strategy_after
      end
      def flipflop_cookie_strategy_before
        CookieStrategy.cookies = cookies
      end
      def flipflop_cookie_strategy_after
